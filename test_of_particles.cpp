...
int main()
{
    ...
    source.getComponent<qqq::ParticleSource>()->setParameters(10, 50, 1, 270, 0, {300, 1}, 0);
    ...
    source_2.getComponent<qqq::ParticleSource>()->setParameters(10, 100, 10, -1, 1);
    ...
    source_3.getComponent<qqq::ParticleSource>()->setParameters(1, 10, 6, 0);
